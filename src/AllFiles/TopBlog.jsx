...
const TopBlog = () => {
    return (
        <div id='top' className='-m-[7vh] shadow-md w-[80%] self-center relative z-10 px-8 rounded-t-4xl bg-white min-h-screen'>
            ...
            <div className='grid gap-8 grid-cols-3'>
                <motion.div variants={fadeIn("right", 0.1)}
                    ...
                    <img src="https://www.mrsindiaqueen.com/blog/uploads/images/2024/12/image_750x_676515e9295e5.jpg" className='w-full h-[450px] object-cover rounded-2xl' loading='lazy' alt="image" />
                ...
                <div className='flex gap-4 flex-col'>
                    ...
                    <motion.div
                        ...
                        <img src="https://cms.menutiger.com/wp-content/uploads/2024/02/white-wine-and-salmon-dish-on-the-table-1024x536.jpg" className='w-full object-cover h-[175px] rounded-2xl' loading='lazy' alt="image" />
